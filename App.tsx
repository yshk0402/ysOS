...
import { Minus, Square, X, ExternalLink, FileText, Monitor, Cpu, LogOut, Volume2} from 'lucide-react';
        ...
        <div className="flex h-full">
            ...
            <div className="flex-1 flex flex-col p-1 gap-1">
                ...
                <div className="hover:bg-[#000080] hover:text-white p-1 flex items-center gap-2 cursor-pointer" onClick={() => handleClick(AppId.SETTINGS)}>
                 ...
                 <div className="hover:bg-[#000080] hover:text-white p-1 flex items-center gap-2 cursor-pointer">
